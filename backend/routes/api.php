...
use App\Http\Controllers\Api\Admin\BoxingAdminController;
use App\Http\Controllers\Api\Admin\BoxingScraperController;
use App\Http\Controllers\Api\BoxingHomeController;
...
Route::prefix('v1')->group(function () {
    ...
    Route::prefix('boxing')->group(function () {
        Route::get('/home', BoxingHomeController::class);
        ...
        Route::get('/events/{event}/fight-card', [EventController::class, 'fightCard']);
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::prefix('admin')->name('admin.')->middleware(['role:admin|moderator', 'verify.license'])->group(function () {
            ...
            // BoxingDB data management
            Route::prefix('boxingdb/scraper')->controller(BoxingScraperController::class)->group(function () {
                Route::get('/status', 'status');
            ...
            Route::prefix('boxingdb')->controller(BoxingAdminController::class)->group(function () {
                ...
                Route::get('/{resource}/{id}', 'show')->whereNumber('id');
                Route::put('/{resource}/{id}', 'update')->whereNumber('id');
                Route::delete('/{resource}/{id}', 'destroy')->whereNumber('id');
            });
