  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: '/boxingdb/scraper',
          name: 'boxingdb-scraper',
          component: () => import('../views/BoxingDB/BoxingScraperView.vue')
        },
        {
          path: '/boxingdb/:resource',
          name: 'boxingdb-manager',
          component: () => import('../views/BoxingDB/BoxingDbManager.vue')
        }
      ]
    }
  ]
